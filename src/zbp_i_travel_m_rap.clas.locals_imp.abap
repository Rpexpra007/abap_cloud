...
CLASS lhc_travel DEFINITION INHERITING FROM cl_abap_behavior_handler.
  ...
  PRIVATE SECTION.
    ...
    TYPES tt_travel_update TYPE TABLE FOR UPDATE zi_travel_m_RAP.
...
********************************************************************************
  METHOD get_features.
    ...
    READ ENTITY zi_travel_m_RAP FROM VALUE #( FOR keyval IN keys
                                                      (  %key                    = keyval-%key
  ...
  METHOD validate_agency.
    ...
    READ ENTITY zi_travel_m_RAP\\travel FROM VALUE #(
  ...
  METHOD calculatetravelkey.
    READ ENTITIES OF zi_travel_m_RAP IN LOCAL MODE
        ENTITY Travel
          FIELDS ( travel_id )
    ...
    "Get max travelID
    SELECT SINGLE FROM ztravel_RAP FIELDS MAX( travel_id ) INTO @DATA(lv_max_travelid).

    "update involved instances
    MODIFY ENTITIES OF zi_travel_m_RAP IN LOCAL MODE
      ENTITY Travel
