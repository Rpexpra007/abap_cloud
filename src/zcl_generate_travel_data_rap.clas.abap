CLASS zcl_generate_travel_data_RAP DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_generate_travel_data_RAP IMPLEMENTATION.
  METHOD if_oo_adt_classrun~main.

    DATA itab TYPE TABLE OF ztravel_RAP.
...
*   delete existing entries in the database table
    ...
    DELETE FROM ztravel_RAP.

*   insert the new table entries
    INSERT ztravel_RAP FROM TABLE @itab.
